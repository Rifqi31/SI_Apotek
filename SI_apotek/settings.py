"""
Django settings for SI_apotek project.
...
SECRET_KEY = 'sbpoj)t2iegqm8i2giv2azb-)x6us-wh3m#sm^pw78g@q=%ecb'
...
WSGI_APPLICATION = 'SI_apotek.wsgi.application'
